...
class StoreBacklinkRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'source_url.max' => "L'URL source ne peut pas dépasser 2048 caractères.",
            'target_url.required' => "L'URL cible est requise.",
            'target_url.url' => "L'URL cible doit être une URL valide.",
            'target_url.max' => "L'URL cible ne peut pas dépasser 2048 caractères.",
            'anchor_text.max' => "Le texte d'ancre ne peut pas dépasser 500 caractères.",
        ];
    }
}
