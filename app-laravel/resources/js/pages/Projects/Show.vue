...
<template>
    <div class="container mx-auto px-4 py-8">
        ...
        <div v-else-if="project" class="max-w-4xl mx-auto">
            ...
            <!-- Future: Backlinks Stats Card -->
            <div class="bg-gray-50 rounded-lg border border-gray-200 p-6 mb-6">
                <h2 class="text-lg font-semibold text-gray-900 mb-4">Statistiques des backlinks</h2>
                <p class="text-gray-600 text-sm">
                    Cette section affichera les statistiques des backlinks lors du Sprint 2.
                </p>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                    <div class="bg-white rounded-lg border border-gray-200 p-4 text-center">
                        <p class="text-3xl font-bold text-gray-400">0</p>
                        <p class="text-sm text-gray-600 mt-1">Backlinks actifs</p>
                    </div>
                    <div class="bg-white rounded-lg border border-gray-200 p-4 text-center">
                        <p class="text-3xl font-bold text-gray-400">0</p>
                        <p class="text-sm text-gray-600 mt-1">Backlinks perdus</p>
                    </div>
                    <div class="bg-white rounded-lg border border-gray-200 p-4 text-center">
                        <p class="text-3xl font-bold text-gray-400">0</p>
                        <p class="text-sm text-gray-600 mt-1">Total backlinks</p>
                    </div>
                </div>
            </div>
