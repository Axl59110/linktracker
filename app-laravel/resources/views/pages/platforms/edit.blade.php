...
@section('title', 'Modifier une plateforme - Link Tracker')
...
@section('content')
    <x-page-header title="Modifier la plateforme" subtitle="Mettez à jour les informations de la plateforme" />
            ...
            <div class="space-y-6">
                ...
                <div class="space-y-1">
                    ...
                    >
                        ...
                        <option value="marketplace" {{ old('type', $platform->type) === 'marketplace' ? 'selected' : '' }}>Marketplace</option>
                        <option value="direct" {{ old('type', $platform->type) === 'direct' ? 'selected' : '' }}>Contact Direct</option>
                        <option value="other" {{ old('type', $platform->type) === 'other' ? 'selected' : '' }}>Autre</option>
                    </select>
                    @error('type')
